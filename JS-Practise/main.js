...
//   1
console.log(countries_data.sort((a,b)=>b.name.localeCompare(a.name.localeCompare)));
...
let englishLan = countries_data.filter((el) => el.languages.includes('English')) ;
console.log(englishLan);

let englishRegionAsiaEurope = countries_data.filter((el)=>(el.region==='Europe') || (el.region==='Asia'))
console.log(englishRegionAsiaEurope);

let multiLansArr=countries_data.filter((el)=>el.languages.length>1) 
console.log(multiLansArr);

console.log(countries_data.map((el)=> {
    return `${el.name} , ${el.capital}`
}
));
